    ...
    return (
        <div>
            ...
            <form onSubmit={(e) => loginUser(formData, e)} className="w-1/3 mx-auto">
                ...
                <button type="submit" className="inline mt-5 rounded-md px-2 py-2 shadow-sm font-semibold tracking-wide text-sm my-2 leading-4 cursor-pointer bg-blue-500 text-white"> Login </button>
                <button className="m-2 inline text-sm text-blue-500 underline cursor-pointer">
                    <a href="/register">
                        Register
                    </a>
                </button>
